                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php
                                                if($professionista->stato == 1) {
                                                ?>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-x-square-fill fs-5 text-primary" style="margin-left: 0px;" onclick="attivaProfessionista('<?=$professionista->cf?>')">
